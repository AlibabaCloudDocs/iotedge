...
2.  根据环境设置软件安装相关参数，然后单击**生成安装命令**。
    ...
    ![下载命令](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/zh-CN/4249922951/p45194.png)
...
3.  复制软件包下载命令备用。
    ...
    ![复制命令](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/zh-CN/4249922951/p45201.png)

4.  登录您的Windows7或Windows10系统的机器。

5.  在git bash运行环境任意目录下执行步骤3中已复制的命令。

    ![gitbash中执行LE安装命令](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/zh-CN/4249922951/p85644.png)
    ...
    -   如果您第一次启动网关，则需要完成如下交互式配置，您可以直接按**Enter**键使用默认配置。
        ...
        ![查看执行结果](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/zh-CN/4249922951/p37204.png)
...
8.  （可选）在实例详情页面选择**网关**，打开**远程访问**按钮后，可对网关进行远程管理，详细操作步骤请参见[远程服务访问](/cn.zh-CN/用户指南/远程运维管理/远程服务访问.md)。

9.  （可选）Link IoT Edge支持将边缘实例授权给其他阿里云用户操作。
