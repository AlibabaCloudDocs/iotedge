...
[您可以在OpenAPI Explorer中直接运行该接口，免去您计算签名的困扰。运行成功后，OpenAPI Explorer可以自动生成SDK代码示例。](https://api.aliyun.com/#product=Iot&api=RefreshDeviceTunnelSharePassword&type=RPC&version=2018-01-20)

## 请求参数

|名称|类型|是否必选|示例值|描述|
|--|--|----|---|--|
|Action|String|是|RefreshDeviceTunnelSharePassword|系统规定参数。取值：RefreshDeviceTunnelSharePassword。 |
...
|Password|String|5f5c96d7e792af75da33a81dc87982ea\*\*\*\*\*\*\*\*|新的隧道分享密码。 |
|RequestId|String|46AF6619-EFF3-4B77-A90B-B9EAA0C6D1AF|阿里云为该请求生成的唯一标识符。 |
...
```
http(s)://iot.cn-shanghai.aliyuncs.com/?Action=RefreshDeviceTunnelSharePassword
&ProductKey=a1Wmy******
