...
[您可以在OpenAPI Explorer中直接运行该接口，免去您计算签名的困扰。运行成功后，OpenAPI Explorer可以自动生成SDK代码示例。](https://api.aliyun.com/#product=Iot&api=EnableDeviceTunnel&type=RPC&version=2018-01-20)

## 请求参数

|名称|类型|是否必选|示例值|描述|
|--|--|----|---|--|
|Action|String|是|EnableDeviceTunnel|系统规定参数。取值：EnableDeviceTunnel。 |
...
|RequestId|String|577F07AF-7EFE-4B98-AEA2-634ED864BA01|阿里云为该请求生成的唯一标识符。 |
...
```
http(s)://iot.cn-shanghai.aliyuncs.com/?Action=EnableDeviceTunnel
&ProductKey=a1Wmy******
